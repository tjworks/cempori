...
class AddInMage_SpreadTheWord_Model_Configuration_AllowedSocialServices extends Mage_Core_Model_Config_Data
{
	...
	public static function getServices()
	{
		...
		if (! isset($services ['social'])) return $services_array;
		
		foreach ($services ['social'] as $service) {
			if (class_exists('AddInMage_SpreadTheWord_Helper_Services_' . ucfirst($service))) {
				...
				if ($service_data ['type'] == 'social') $services_array [] = $service_exist;
			}
		}
