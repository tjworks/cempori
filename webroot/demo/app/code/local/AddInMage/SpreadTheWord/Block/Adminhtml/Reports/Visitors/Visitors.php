...
class AddInMage_SpreadTheWord_Block_Adminhtml_Reports_Visitors_Visitors extends Mage_Adminhtml_Block_Widget_Grid_Container
{

	public function __construct()
	{
		$this->_blockGroup = 'spreadtheword';
		$this->_controller = 'adminhtml_reports_visitors_visitors';
		$this->_headerText = $this->__('Statistics by Customer Type');
		parent::__construct();
	...
	public function getFilterUrl()
	{
		...
		return $this->getUrl('*/*/visitors_statistics', array ('_current' => true));
	}
