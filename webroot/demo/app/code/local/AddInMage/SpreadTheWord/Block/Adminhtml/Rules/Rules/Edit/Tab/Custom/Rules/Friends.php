...
class AddInMage_SpreadTheWord_Block_Adminhtml_Rules_Rules_Edit_Tab_Custom_Rules_Friends extends AddInMage_SpreadTheWord_Block_Adminhtml_Rules_Rules_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
	protected $_rule = 'friends';
	...
	{
		return $this->__('Service Targeting For Friends');
	}
