...
class AddInMage_SpreadTheWord_Block_Adminhtml_Reports_Service_Treemap extends Mage_Adminhtml_Block_Widget_Grid_Container
{

	public function __construct()
	{
		$this->_blockGroup = 'spreadtheword';
		$this->_controller = 'adminhtml_reports_service_treemap';
		$this->_headerText = $this->__('Service Popularity Tree Map');
		parent::__construct();
	...
	public function getFilterUrl()
	{
		...
		return $this->getUrl('*/*/service_popularity_treemap', array ('_current' => true));
	}
